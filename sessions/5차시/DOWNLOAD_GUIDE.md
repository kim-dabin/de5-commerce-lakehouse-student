# 05차시 자료: Spark와 Iceberg Batch BI

이 폴더는 데이터 엔지니어 부트캠프 5기 B주제 라이브 스터디의 05차시 수강생 실습 자료입니다.

## 이번 차시 범위

Paimon Bronze를 Spark로 정제해 Iceberg analytics 테이블을 만들고, 일 단위 이벤트/카테고리 BI 결과를 조회합니다.
