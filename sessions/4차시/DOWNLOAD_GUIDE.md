# 04차시 자료: Flink와 Paimon Bronze

이 폴더는 데이터 엔지니어 부트캠프 5기 B주제 라이브 스터디의 04차시 수강생 실습 자료입니다.

## 이번 차시 범위

Kafka 이벤트를 Flink SQL로 읽어 Paimon Bronze 테이블에 저장하고 row count와 event type 집계를 확인합니다.
