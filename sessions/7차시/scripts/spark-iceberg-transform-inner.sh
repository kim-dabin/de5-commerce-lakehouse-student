...
SPARK_PACKAGES="${SPARK_PACKAGES:-org.apache.paimon:paimon-spark-3.5_2.12:${PAIMON_VERSION},org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:${ICEBERG_VERSION},org.apache.iceberg:iceberg-aws-bundle:${ICEBERG_VERSION}}"
...
/opt/spark/bin/spark-submit \
  ...
  /workspace/labs/05-spark-iceberg/transform_to_iceberg.py
